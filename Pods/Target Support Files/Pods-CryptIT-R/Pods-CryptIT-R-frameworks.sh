...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KBRoundedButton/KBRoundedButton.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RSASwiftGenerator/RSASwiftGenerator.framework"
